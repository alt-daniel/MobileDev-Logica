...
class LogicaActivity : AppCompatActivity() {
    ...
    val EMPTY_TEXT = "One or more fields are empty!"
    val CORRECT_MESSAGE = "All answers are CORRECT_MESSAGE!"
    val INCORRECT_MESSAGE = "One or more answers are incorrect!"
    ...
    private fun getAnswer() {
        ...
        if (resultText1.isEmpty() || resultText2.isEmpty() || resultText3.isEmpty() || resultText4.isEmpty()) {
            ...
            Toast.makeText(this, CORRECT_MESSAGE, Toast.LENGTH_SHORT)
                .show()
        } else {
            Toast.makeText(this, INCORRECT_MESSAGE, Toast.LENGTH_SHORT)
                .show()
        }
    }
}
